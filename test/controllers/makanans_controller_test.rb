...
class MakanansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create makanan" do
    assert_difference("Makanan.count") do
      post makanans_url, params: { makanan: { deskripsi: @makanan.deskripsi, harga: @makanan.harga, kategori_id: @makanan.kategori_id, nama_makanan: @makanan.nama_makanan } }
    end
  ...
  test "should update makanan" do
    patch makanan_url(@makanan), params: { makanan: { deskripsi: @makanan.deskripsi, harga: @makanan.harga, kategori_id: @makanan.kategori_id, nama_makanan: @makanan.nama_makanan } }
